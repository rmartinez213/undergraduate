...
<body>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span>Sign
								Up </a>
							<ul class="dropdown-menu">
								<li><a href="../Login/Registration">
										<!--  <span class="label label-warning">4:00 AM</span> -->Register
										Now!
								</a></li>
								<li><a href="../Login/Signin">
	...
	<div align="center"
		...
		We are an ecommerce website introducing a fresh (no pun intended) way
		to deliver eggs to people in local areas by allowing local farmers in
		your local area expand their business by selling you the fresh eggs on
		the market. This is a great way to help local farmers by selling their
		product to the public and also delivering the best eggs straight to
		your door! We currently have 3 farmers available to sell on our
		website and we plan on adding many more farmers so that you the
		customer can enjoy a variety of eggs from different farms. Stay tuned
		for continuing update on our farmers and be sure to leave a comment in
		the contact us if you have an concerns or comments.</div>
